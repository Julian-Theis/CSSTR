...
class TestRegistrationForm(forms.ModelForm):
    ...
    streetaddress = forms.CharField(max_length=100, label="Strasse und Hausnummer")
    ...
    streetaddress_2 = forms.CharField(max_length=100, label="Strasse und Hausnummer", required=False)
    ...
    streetaddress_3 = forms.CharField(max_length=100, label="Strasse und Hausnummer", required=False)
    ...
    streetaddress_4 = forms.CharField(max_length=100, label="Strasse und Hausnummer", required=False)
    ...
    streetaddress_5 = forms.CharField(max_length=100, label="Strasse und Hausnummer", required=False)
